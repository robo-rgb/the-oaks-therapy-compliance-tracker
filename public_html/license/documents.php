...
<nav><a href="<?= e(app_base_path('dashboard.php')) ?>">Dashboard</a> | <a href="<?= e(app_base_path('license.php')) ?>">License Profile</a> | <a href="<?= e(app_base_path('cycles.php')) ?>">Renewal Cycles</a> | <a href="<?= e(app_base_path('ce/index.php')) ?>">CE Courses</a> | <a href="<?= e(app_base_path('reports/index.php')) ?>">Reports</a> | <a href="<?= e(app_base_path('settings.php')) ?>">Settings</a> | <a href="<?= e(app_base_path('reminders_log.php')) ?>">Reminder Log</a> | <a href="<?= e(app_base_path('documents.php')) ?>">Documents</a><form style="display:inline" method="post" action="<?= e(app_base_path('logout.php')) ?>"><?= csrf_input() ?><button>Logout</button></form></nav>
<h1>Documents</h1>
...
<?php foreach($rows as $r): ?><tr><td><?= e((string)$r['title']) ?></td><td><?= e((string)$r['document_type']) ?></td><td><?= e((string)($r['course_title']??'')) ?></td><td><?= e((string)($r['renewal_cycle_id']??'')) ?></td><td><?= e((string)$r['uploaded_at']) ?></td><td><?= e((string)$r['original_filename']) ?></td><td><?= e((string)$r['file_size']) ?></td><td><a href="<?= e(app_base_path('download.php')) . '?id=' . (int)$r['id'] ?>">Download</a> <form method="post" action="<?= e(app_base_path('document_delete.php')) . '?id=' . (int)$r['id'] ?>" style="display:inline"><?= csrf_input() ?><button>Delete</button></form></td></tr><?php endforeach; ?></table>
</body></html>
